...
const translations = {
  nl: {
    ...
    /* Hero */
    'hero-tag':        '✦ Erkend installateur – Mol, België',
    'hero-title-1':    'Uw specialist in',
    'hero-title-2':    'verwarming &',
    'hero-title-3':    'airconditioning',
    'hero-desc':       'Meer dan 25 jaar ervaring in de installatie, het onderhoud en de herstelling van centrale verwarmingssystemen en airconditioning. Lokale service, vakkundig uitgevoerd.',
    ...
    'srv1-desc':       'Plaatsing van nieuwe cv-ketels en complete verwarmingsinstallaties voor uw woning of appartement.',
    'srv2-title':      'CV-onderhoud',
    ...
    'srv3-desc':       'Snelle diagnose en herstelling van storingen aan uw cv-ketel of verwarmingssysteem. Geen warmte? Wij lossen het op.',
    'srv4-title':      'Airconditioning',
    'srv4-desc':       'Levering en installatie van airconditioningssystemen voor een aangenaam binnenklimaat het hele jaar door.',

    /* About */
    'about-tag':       'Over Van Hoof & Co',
    'about-title':     'Uw vertrouwde lokale partner',
    'about-p1':        'Van Hoof & Co is een bvba opgericht in 2000, gevestigd in Mol. Met een klein, hecht team van vakbekwame technici werken wij uitsluitend voor particuliere klanten in de regio.',
    'about-p2':        'Onze kracht ligt in persoonlijk contact, kwaliteitswerk en eerlijke prijzen. U belt ons, wij zijn er. Van de eerste offerte tot de laatste schroef – altijd met zorg afgewerkt.',
    'badge1-title':    '25+ jaar ervaring',
    'badge1-sub':      'Actief in de sector sinds 2000',
    ...
    'gallery-sub':     'Een greep uit ons werk – van CV-installaties tot airconditioningprojecten.',
    'gallery1-cap':    'CV-installatie – Mol',
    'gallery2-cap':    'Jaarlijks onderhoud – Dessel',
    'gallery3-cap':    'Airconditioning – Geel',

    /* Contact */
    'contact-tag':     'Contact',
    'contact-title':   'Neem contact op',
    'contact-sub':     'Vragen over een offerte, een herstelling of onderhoud? Wij helpen u graag verder.',
    'lbl-address':     'Adres',
    'lbl-phone':       'Telefoon',
    'lbl-email':       'E-mail',
  ...
  en: {
    ...
    'hero-desc':       'Over 25 years of experience in the installation, maintenance, and repair of central heating systems and air conditioning. Local service, expertly delivered.',
    ...
    'about-p1':        'Van Hoof & Co is a bvba (private limited company) founded in 2000, based in Mol. With a small, dedicated team of skilled technicians, we work exclusively for residential customers in the region.',
    ...
    'badge1-title':    '25+ years of experience',
    'badge1-sub':      'Active in the sector since 2000',
